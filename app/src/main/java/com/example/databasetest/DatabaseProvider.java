...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORTY  = "com.example.databasetest.provider";
    ...
    static {
        ...
        uriMatcher.addURI(AUTHORTY,"book", BOOK_DIR);
        uriMatcher.addURI(AUTHORTY, "book/*" , BOOK_ITEM);
        uriMatcher.addURI(AUTHORTY, "catagory", CATEGORY_DIR);
        uriMatcher.addURI(AUTHORTY, "catagory/#", CATEGORY_ITEM);
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatcher.match(uri)){
            ...
            case BOOK_ITEM:
                ...
                uriReturn = Uri.parse("content://" + AUTHORTY + "/category/" + newCategoryId);
                break;
            default:
                break;
        }
